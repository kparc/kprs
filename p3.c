#include<tree_sitter/api.h>                        //tree pretty-printer, for lulz&giggles
#include<string.h>                                 //(c) 2020-now lelf; kparc
#include"c.h"
...
TSLanguage*tree_sitter_k(); TSLanguage*K;
...
I ttv(TSTreeCursor*c,S s,I d){
 ...
 $(TN(is_missing)(n),O("MISSING"))$(strcmp(t,u),O("｢%s｣",u)); O("\n");
